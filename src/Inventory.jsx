...
//       <div className="num-badge">{expiring}</div>
...
//                     <button className="btnEdit"><i class="fa-solid fa-pencil"></i></button>
//                     <button className="btnDelete"><i class="fa-solid fa-trash"></i> </button>
//                   </td>
//                 </tr>
//               ))
//             )}
